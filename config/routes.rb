Rails.application.routes.draw do
    ...
    #generate changes Carlos Andrés Castiblanco Catro TSG Colombia
    #  get 'project_and_rol_controller/getproyectandrol'
    post 'create_device_rest' => 'users_rest#create_device_rest'
    post 'set_temporary_state' => 'set_temporary_state_rest#validate_state'
    post 'get_description_by_issue_id' => 'description_site_rest#get_description_by_issue_id'
    post 'create_description_site' => 'description_site_rest#create_description_site'
    post 'update_issues' => 'create_and_update_rest#update_issues'
    post 'create_issues' => 'create_and_update_rest#index'
    post 'get_issues' => 'service_rest_list#decodetoken'
    post 'get_sites' => 'service_rest_list#receiveridcordinator'
    post 'get_user' => 'service_rest_list#receiveridproject'
    post 'project_and_rol' => 'project_and_rol#decodetoken'
    ...
    match 'movies/:board_id/topics/new', :to => 'messages#new', :via => [:get, :post], :as => 'new_board_message'
    get 'movies/:board_id/topics/:id', :to => 'messages#show', :as => 'board_message'
    match 'movies/:board_id/topics/quote/:id', :to => 'messages#quote', :via => [:get, :post]
    get 'movies/:board_id/topics/:id/edit', :to => 'messages#edit'

    post 'movies/:board_id/topics/preview', :to => 'messages#preview', :as => 'preview_board_message'
    post 'movies/:board_id/topics/:id/replies', :to => 'messages#reply'
    post 'movies/:board_id/topics/:id/edit', :to => 'messages#edit'
    post 'movies/:board_id/topics/:id/destroy', :to => 'messages#destroy'
